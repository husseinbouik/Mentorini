        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0 navbarstyle">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex align-items-center" href="homepage.php">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar-1">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="upcoming-sessions.php"><i class="icon ion-android-arrow-dropright-circle"></i><span>upcoming sessions</span></a></li>
                                                    ...
                                                    <div id="modal-open-1">
                                                        <div class="modal fade" role="dialog" tabindex="-1" id="exampleModalDecline" aria-labelledby="exampleModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4>confirm</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form>
                                                                            <div class="mb-3"></div>
                                                                            <div class="d-flex flex-row gap-5"></div>
                                                                            <div class="mb-3">
                                                                                <div class="mb-3"><label class="form-label" for="address"><strong>confirm that the session is finished ?&nbsp;</strong></label></div>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                    <div class="modal-footer"><button class="btn btn-warning" style="background-color: var(--bs-info);color: #eff0f1;" type="button">done</button><button class="btn btn-warning" style="background-color: rgb(255,139,160);" type="button" data-bs-dismiss="modal">Close</button></div>
                                                                </div>
                                                            </div>
                                                        </div><button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalDone" style="background-color: var(--bs-info);color: #eff0f1;">Done</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
