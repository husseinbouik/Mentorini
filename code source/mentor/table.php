        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Request</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 fw-bold">sessions Info</p>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <div id="modal-open">
                                                        <div class="modal fade" role="dialog" tabindex="-1" id="exampleModalAccept" aria-labelledby="exampleModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4>Accept the reservation</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form>
                                                                            <div class="mb-3"></div>
                                                                            <div class="d-flex flex-row gap-5"></div>
                                                                            <div class="mb-3">
                                                                                <div class="mb-3"><label class="form-label" for="address"><strong>Link of the meeting (google meet,zoom):</strong></label><input class="form-control" type="text" id="address-4" placeholder="" name="date"></div><label class="form-label" for="city"><strong>Message:</strong></label><textarea class="form-control" id="signature-5" rows="4" name="signature"></textarea>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                    <div class="modal-footer"><button class="btn btn-warning" style="background-color: rgba(111,66,193,0.58);color: #eff0f1;" type="button">Accept</button><button class="btn btn-warning" style="background-color: rgb(255,139,160);" type="button" data-bs-dismiss="modal">Close</button></div>
                                                                </div>
                                                            </div>
                                                        </div><button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalAccept" style="background-color: #4e73df;color: #eff0f1;">Accept</button>
                                                    </div>
                                                    <div id="modal-open-1">
                                                        <div class="modal fade" role="dialog" tabindex="-1" id="exampleModalDecline" aria-labelledby="exampleModalLabel">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4>Decline the reservation</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form>
                                                                            <div class="mb-3"></div>
                                                                            <div class="d-flex flex-row gap-5"></div>
                                                                            <div class="mb-3">
                                                                                <div class="mb-3"><label class="form-label" for="address"><strong>Link of the meeting (google meet,zoom):</strong></label><input class="form-control" type="text" id="address-1" placeholder="" name="date"></div><label class="form-label" for="city"><strong>Message:</strong></label><textarea class="form-control" id="signature-1" rows="4" name="signature"></textarea>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                    <div class="modal-footer"><button class="btn btn-warning" style="background-color: var(--bs-red);color: #eff0f1;" type="button">Decline</button><button class="btn btn-warning" style="background-color: rgb(255,139,160);" type="button" data-bs-dismiss="modal">Close</button></div>
                                                                </div>
                                                            </div>
                                                        </div><button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#exampleModalDecline" style="background-color: var(--bs-danger);color: #eff0f1;">Decline</button>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
