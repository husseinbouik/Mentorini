...
<body><a class="btn btn-link link-primary mb-3" role="button" href="index.html" style="text-decoration: none;margin-top: 28px;margin-left: 24px;"><i class="fas fa-arrow-left"></i>&nbsp;Back</a>
    <div class="card shadow-lg o-hidden border-0" style="margin: 4%;">
        <div class="card-body p-0">
            <div class="row">
                <div class="col-lg-6 d-none d-lg-flex">
                    <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/karytonndev_background.jpg&quot;);"></div>
                </div>
                <div class="col-lg-6">
                    <div class="p-5">
                        ...
                        <form  action="mentor-login.php" method="post" id="form" class="form user" enctype="multipart/form-data">
                        ...
                        <div class="text-center"><a class="small" href="signUp-mentor.php">Create an Account!</a></div>
                    </div>
                </div>
            </div>
        </div>
