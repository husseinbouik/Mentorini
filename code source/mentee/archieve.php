...
<body>
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="homepage.php">
            ...
            <div class="collapse navbar-collapse" id="navcol-3" style="margin-right: -3px;">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active fw-semibold" href="archieve.php"><i class="fas fa-th-list" style="margin-right: 4px;font-size: 18px;"></i>Archieve</a></li>
                </ul>
    ...
    <div class="container d-flex flex-wrap" style="margin-top: 152px;">
        <div class="card" style="width: 18rem;border-top-left-radius: 20px;border-top-right-radius: 20px;border-bottom-right-radius: 20px;border-bottom-left-radius: 20px;box-shadow: 5px 5px 16px 2px rgba(0,0,0,0.25);margin: 14px;min-width: 280px;max-width: 300px;margin-bottom: 20px;border-color: #000000;">
            ...
            <div class="card-body d-flex flex-column" style="height: 262px;">
                <div>
                    <h4 style="font-family: 'Source Sans Pro', sans-serif;font-weight: 700;color: rgb(255,160,0);">Web development program</h4>
                    <h6 class="text-muted mb-2" style="font-family: 'Source Sans Pro', sans-serif;font-weight: 600;color: #757575;">vaerie Luna</h6>
                    <div class="d-flex gap-3" style="padding-left: 121px;">
                        <div id="modal-open-1" style="margin-left: 31px;">
                            <div class="modal fade" role="dialog" tabindex="-1" id="exampleModal-1" aria-labelledby="exampleModalLabel">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4>Cancel the reservation</h4><button class="btn-close" type="button" aria-label="Close" data-bs-dismiss="modal"></button>
                                        </div>
                                        <div class="modal-body">
                                            <p>are you sure you&nbsp; want to cancel this reservation ?</p>
                                        </div>
                                        <div class="modal-footer"><button class="btn btn-warning" style="background-color: rgb(244,45,82);color: #f9f9fe;" type="button" data-bs-dismiss="modal">Confirm</button><button class="btn btn-warning" style="background-color: var(--bs-yellow);color: #f9f9fe;" type="button" data-bs-dismiss="modal">Close</button></div>
                                    </div>
                                </div>
                            </div><button class="btn btn-warning cancel-btn" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="far fa-times-circle" style="font-size: 19px;margin-right: 6px;"></i>Cancel</button>
                        </div>
                    </div>
                    <div><span><br><i class="icon ion-android-time" style="font-size: 14px;margin-right: 6px;"></i>Date :&nbsp; 11/05/20 32&nbsp; 12:00-14:00<br><br></span></div>
                </div>
            </div>
        </div>
    </div>
