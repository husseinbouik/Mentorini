            ...
            <div class="collapse navbar-collapse" id="navcol-3" style="margin-right: -3px;">
                ...
                <ul class="navbar-nav flex-nowrap ms-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><?php echo $full_name; ?></span><img class="border rounded-circle img-profile" src="profil_pic_mentee/<?php echo $image_path; ?>" width="49" height="49"></a>
...
<?php endif; ?>
    ...
    <div class="row" style="margin-bottom: 25px;text-align: left;">
        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-2 col-xxl-2" style="display: inline;text-align: center;margin-bottom: 25px;">
            <img class="rounded-circle mb-3 mt-4 img-fluid" src="profil_pic_mentee/<?php echo $image_path; ?>" style="display: inline;max-height: 110px;" width="110" height="110"><br>
            <div id="modal-open-8">
