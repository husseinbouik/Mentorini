...
// Check if the mentee object is stored in the session
if (isset($_SESSION['mentee_id'])) {
    $mentee_id = $_SESSION['mentee_id'];
    $mentee = new Mentee();
    $mentee->get_mentee_by_id($mentee_id);

    // Use the mentee object's properties to display the mentee data
    $first_name = $mentee->getFirstName();
    $last_name = $mentee->getLastName();
    $email = $mentee->getEmail();
    $password = $mentee->getPassword();
    $image_path = $mentee-> getImagePath();
    $full_name = $first_name . ' ' . $last_name;
} else {
    // If the mentee object is not in the session, redirect to the login page
    echo 'error';
}
        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="homepage.php">
            ...
            <div class="collapse navbar-collapse" id="navcol-3" style="margin-right: -3px;">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item"><a class="nav-link active fw-semibold" href="homepage.php"><i class="fas fa-home" style="margin-right: 4px;font-size: 18px;"></i>Home&nbsp;</a></li>
                    <li class="nav-item"><a class="nav-link fw-semibold" href="#about"></a></li>
                    <li class="nav-item"><a class="nav-link fw-semibold" href="Current-Mentorships.php"><i class="fas fa-window-restore" style="margin-right: 4px;font-size: 18px;"></i>Current Mentorships</a></li>
                ...
                <ul class="navbar-nav flex-nowrap ms-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><?php echo $full_name; ?></span><img class="border rounded-circle img-profile" src="profil_pic/<?php echo $image_path; ?>" width="49" height="49"></a>
...
<?php endif; ?>
    ...
    <div class="row" style="margin-bottom: 25px;text-align: left;">
        <div class="col-sm-4 col-md-4 col-lg-3 col-xl-2 col-xxl-2" style="display: inline;text-align: center;margin-bottom: 25px;">
            <img class="rounded-circle mb-3 mt-4 img-fluid" src="profil_pic/<?php echo $image_path; ?>" style="display: inline;max-height: 110px;" width="110" height="110"><br>
            <div id="modal-open-8">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-8 col-lg-8 offset-sm-0 offset-md-2">
                                        <div class="file-upload-wrapper">
                                            <div class="view file-upload" style="padding-bottom: 7px;padding-right: 4px;">
                                                <input class="form-control file_upload" type="file" id="profile_pic" name="profile_pic">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-primary btn-sm ment-btn-style" type="submit">Change Photo</button>
                                <button class="btn btn-warning" style="background-color: rgb(255,139,160);" type="button" data-bs-dismiss="modal">Close</button>
                            </div>
                        </div>
                    </div>
                </div>
                <button class="btn btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Change Profile Picture</button>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 text-start">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="email" id="email" placeholder="user@example.com" value="<?php echo $email; ?>" name="email" required="">
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                ...
                <input class="form-control" type="text" placeholder="John" value="<?php echo $first_name; ?>" name="first_name" required="">
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-3">
                <label class="form-label" for="last_name"><strong>Last Name</strong></label>
                <input class="form-control" type="text" placeholder="Doe" value="<?php echo $last_name; ?>" name="last_name" required="">
            </div>
        </div>
        <div class="col-md-6 text-start">
            <div class="mb-3">
                <label class="form-label" for="current_password"><strong>Current Password</strong></label>
                <input class="form-control" type="password" id="current_password" name="current_password" placeholder="Password">
            </div>
        </div>
        <div class="col-md-6 text-start">
            <div class="mb-3">
                <label class="form-label" for="new_password"><strong>New Password</strong></label>
                <input class="form-control" type="password" id="new_password" name="new_password" placeholder="Password">
            </div>
        </div>
        <div class="col-md-6 text-start">
            <div class="mb-3">
        ...
        <div class="col-md-12" style="text-align: right;margin-top: 5px;">
            <button class="btn btn-primary btn-sm" id="submitBtn" type="submit">Save Settings</button>
        </div>
    </div>
</form>
            </div>
