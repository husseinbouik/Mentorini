        ...
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="homepage.php">
            ...
            <div class="collapse navbar-collapse" id="navcol-3" style="margin-right: -3px;">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active fw-semibold" href="Current-Mentorships.php"><i class="fas fa-window-restore" style="margin-right: 4px;font-size: 18px;"></i>Current Mentorships</a></li>
