...
<body>
    <div class="container" style="margin-top: 18px;margin-bottom: 38px;"><a class="btn btn-link link-primary mb-3" role="button" href="index.html"><i class="fas fa-arrow-left"></i>&nbsp;Back</a><div id="main-wrapper" class="container">
                ...
                <div class="card-body p-0">
                    <div class="row no-gutters">
                        <div class="col-lg-6">
                            <div class="p-5">
                                                             <div class="mb-5">
                                    <h3 class="h4 font-weight-bold text-theme">Log In</h3>
                                </div>
    ...
    <div class="account-testimonial">
                                    <h4 class="text-white mb-4">Build the career of your job</h4>
                                    <p class="lead text-white">"Best investment </p>
                                    <p>-Mentorini</p>
                                </div>
                            </div>
                        </div>
